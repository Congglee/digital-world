...
import ProductDetailTabs from 'src/pages/ProductDetail/components/ProductDetailTabs'
import ProductExtraInfomation from 'src/pages/ProductDetail/components/ProductExtraInfomation'
import ProductImages from 'src/pages/ProductDetail/components/ProductImages'
import ProductInfomation from 'src/pages/ProductDetail/components/ProductInfomation'
import RelateProducts from 'src/pages/ProductDetail/components/RelateProducts'
