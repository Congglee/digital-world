...
export const hotCollections = [
...

  {
    ...
    brands: ['Apple Macbook Air', 'Apple Macbook Pro 13', 'Apple Macbook Pro 14', 'Apple Macbook Pro 16']
  }
]
...
export const blogPosts = [
  ...
  {
    title: 'Core i9-13900HX cho laptop lộ điểm hiệu năng vượt trội với thế hệ tiền nhiệm',
    thumb:
      'https://res.cloudinary.com/di3eto0bg/image/upload/v1695210329/ecommerce-techshop/1746_cover_corei9_13900hx_egyph3.jpg',
    date: 'December 20, 2022',
    total_comments: 5,
    description: 'Core i9-13900HX cho laptop lộ điểm hiệu năng cao hơn cả Core i9-12900K và Ryzen 9 7900X'
  },
  {
