...
import { accountsVerifyStatusLabels } from 'src/constants/verifyStatus'
...
export const getVerifyStatusLabel = (status: number) => accountsVerifyStatusLabels[status] || 'Unknown'
