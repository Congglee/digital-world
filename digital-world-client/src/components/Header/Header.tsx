import { AlignJustify, Banknote, ChevronDown, PhoneCall, Search, ShoppingCart } from 'lucide-react'
...
function DesktopTopHeader() {
  return (
    <div className='bg-[#f0f0f0] text-[#505050] py-[10px] hidden md:block'>
  ...
  return (
    <header>
      ...
      <div className='md:py-10 text-[#505050]'>
        <div className='container'>
          <MenuDrawer active={active} setActive={setActive} />
          <DesktopHeader />
