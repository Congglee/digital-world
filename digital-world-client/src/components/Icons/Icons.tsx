...
export function DongCoin(props: IconProps) {
  return (
    <svg {...props} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 384 512' className={props.className}>
...
export function FilterIcon(props: IconProps) {
  return (
    <svg
      ...
      focusable='false'
      role='presentation'
      className={`icon icon-filter ${props.className || ''}`}
      fill='none'
      viewBox='0 0 20 41'
    >
      <line x1='16.5' y1='17.5' x2='3.5' y2='17.5' stroke='#3F7972' strokeLinecap='round' />
      <line x1='16.5' y1='24.5' x2='3.5' y2='24.5' stroke='#3F7972' strokeLinecap='round' />
...
export function CircleX(props: IconProps) {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className={`lucide lucide-circle-x ${props.className || ''}`}
    >
...
export function CircleCheckBig(props: IconProps) {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className={`lucide lucide-circle-check-big ${props.className || ''}`}
    >
...
export function CircleHelp(props: IconProps) {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className={`lucide lucide-circle-help ${props.className || ''}`}
    >
      <circle cx={12} cy={12} r={10} />
